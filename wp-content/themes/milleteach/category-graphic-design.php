                ...
                while ( have_posts() ) : the_post(); ?>
                    <li style="width: auto;">
                        <div class="ts-display-pf-img">
                            ...
                            <a class="image" width="352" height="232" href="<?php echo $image[0]; ?>" data-rel="prettyPhoto[mixed]" >
                            <span class="rollover"></span>
                            <img width="352" height="232" src="<?php echo $image[0]; ?>" alt="" /></a>
                        </div>
                        <div class="ts-display-pf-text" style="margin-left: 400px;height: 232px;">
